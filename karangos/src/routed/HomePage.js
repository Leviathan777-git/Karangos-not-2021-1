...
import imgCarros from '../img/vintage-cars.png'
...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <p>Karangos é um projeto front-end desenvolvido pelo Prof. Fausto Cintra 
            juntamente com a turma do 4º semestre noturno de ADS da Fatec Franca.</p>
    
            <p>Seu objetivo é demonstrar as funcionalidades e possibilidades do React 
            em conjunto com a biblioteca de componentes Material UI, acessando uma API REST remota.,</p>
            ...
            <p className= {classes.paragBotao}>
                    <Button
                        variant="contained" 
                        color="secondary"
                        // chamando a variavel useSatte atraves de uma arrow function so alterando para o seu valor inverso
            ...
            <img src={imgCarros} className={classes.figura} alt="Carros antigos" style={{opacity: visible ? '1' : '0', height: visible ? '591px': '0'}} />
        </>
    )
}